/*
1
//Βρίσκει τα δωμάτια τα οποία ήταν διαθέσιμα στις  18 Μαρτίου 2020 με τιμή $50.00.
//289 rows 
*/
...
/*
3
//Βρίσκει τα δωμάτια που αξιολογήθηκαν στις 2 Ιανουαρίου 2020 και έχουν συνολική βαθμολόγηση 100
//62 rows
*/
...
/*
4
//Βρίσκει τις αξιολογήσεις που έγιναν τον Μάρτιο του 2020 για σπίτια-δωμάτια στην περιοχή Γκάζι(ταξινομημένα με βάση το id του δωματίου)
//27 rows 
*/
...
/*
5
// Βρίσκει τις αξιολογήσεις που έγιναν τον Μάιο του 2020 για σπίτια με τουλάχιστον 2 υπνοδωμάτια και τουλάχιστον 5 κρεβάτια.
...
/*
11
//Βρίσκει το πλήθος των διαφορετικών οικοδεσποτών. 
//1 row
*/
...
/*
12
/Βρίσκει τα 100 πρώτα(με βαση το id) σπίτια-δωμάτια τα οποία βρίσκονται σε περιοχή όπου η συντεταγμένη που εκφράζει το column geometry_coordinates_0_0_87_0 δεν είναι null.
100 rows 
*/
